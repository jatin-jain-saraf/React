...
class Exercise2 extends Component {
    ...
    clickHandlerAdd(e) {
        ...
        if (this.state.data.length === 0) {
            ...
            this.setState.id = this.state.data[this.state.data.length - 1].id + 1
        }
    ...
    clickHandlerEdit(e, id) {
        e.preventDefault()
        this.setState.singleData = this.state.data.find(element => element.id === id)        
        this.setState({
    ...
    clickHandlerUpdate(e) {
        e.preventDefault()
        this.setState.singleData = this.state.data.find(item => item.id === this.state.id)
